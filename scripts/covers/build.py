...
def littles_law():
    """Интенсивность и время пребывания измерены, число заявок в системе — на глаз."""
    return (
...
COVERS = {
    ...
    'littles-law': (littles_law, 'Интенсивность и время пребывания измерены, число заявок в системе — на глаз.'),
}
