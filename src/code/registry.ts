...
export type DeckModule = {
  ...
  widgets?: WidgetSpec;
  /**
   * Врезки внутри текста шага, а не в колонке рядом: колонка занята своим
   * кадром (таблицей требований), а врезка дополняет сам текст — например,
   * карточки HTTP-контракта.
   */
  inlineWidgets?: WidgetSpec;
};
