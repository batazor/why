...
const flow: FlowSpec = {
  ...
  edges: [
    ...
    { id: 't1', source: 'client', target: 'api', sourceHandle: 'r', targetHandle: 'l', label: 'attempt 1 + 2', tone: 'bad', only: ['timeout'] },
    { id: 't2', source: 'api', target: 'bank', sourceHandle: 'r', targetHandle: 'l', label: 'charge 99.00 × 2', tone: 'bad', only: ['timeout'] },
    { id: 't3', source: 'api', target: 'client', sourceHandle: 't', targetHandle: 't', label: 'response lost', tone: 'bad', dashed: true, only: ['timeout'] },
    ...
    { id: 's2', source: 'api', target: 'keys', sourceHandle: 'b', targetHandle: 't', label: 'insert if absent', only: ['store'] },
    ...
    { id: 'h1', source: 'client', target: 'api', sourceHandle: 'r', targetHandle: 'l', label: 'same key, retry', only: ['handler'] },
    { id: 'h2', source: 'api', target: 'keys', sourceHandle: 'b', targetHandle: 't', label: 'key already claimed', only: ['handler'] },
    { id: 'h3', source: 'api', target: 'client', sourceHandle: 't', targetHandle: 't', label: '200, same chargeId', tone: 'ok', only: ['handler'] },
  ],
