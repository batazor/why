  ...
  load: {
    ...
    data: {
      inputs: [
        ...
        /*
         * Сколько джоба ждёт очереди до старта. Входная величина, а не
         * результат: закон Литтла не говорит, каким будет ожидание, — он лишь
         * переводит его в число джоб. Проверяется оно по NFR-8, обещанию про
         * старт в первую минуту.
         */
        { key: 'queueSeconds', min: 1, max: 600, scale: 'log', value: 5 },
